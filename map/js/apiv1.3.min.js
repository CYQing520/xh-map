		...
		if (a8.browser.chrome || a8.browser.safari) {
			a8.extend(cc, {
				...
				defaultCursor : "url(" + cc.imgPath
						+ "openhand.png) 8 8,default",
				draggingCursor : "url(" + cc.imgPath
						+ "closedhand.png) 8 8,move"
			})
		} else {
			a8.extend(cc, {
				distCursor : "url(" + cc.imgPath + "ruler.cur),crosshair",
				defaultCursor : "url(" + cc.imgPath + "openhand.png),default",
				draggingCursor : "url(" + cc.imgPath + "closedhand.png),move"
			})
		}
	}
	function av(cM, cL, T) {
